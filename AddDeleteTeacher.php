                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tbody><?php
                                                ...
                                                if ($cout == 0) {
                                                    echo '<tr>
                                                           <th scope="row"colspan="4">Currently no teacher added yet</th>   
                                                           </tr>';
                                                } else {
                                                    while ($row = $result->fetch_assoc()) {
                                                        echo '<tr>
                                                              ...
                                                              <td><a href="DeleteTeacher.php?TeacherID=' . $row['teacherID'] . '"class="btn btn-outline-warning btn-sm">Delete</a></td>
                                                            </tr>';
                                                        $i++;
                                                    }
                                                }
                                                ?>
                                            <tr>
                                                <th scope="row" colspan="4"><button class="btn btn-outline-primary btn-sm" data-bs-toggle="modal" data-bs-target="#AddTeacherModal">Add Teacher</button></th>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
